      ...
      <main className='mt-5'>
        ...
        <div className='container max-w-full'>
          ...
          <div className='grid grid-cols-1 gap-1 mt-32'>
            <div className='col-span-1 xl:pl-28 lg:pl-28 md:pl-28 sm:pl-28 pl-5'>
              <p id={styles.doreaDefinitionTitle} className='text-xl font-bold'>Why Crypto Dorea?</p>
                <div className='grid grid-cols-5 gap-5 mt-6'>
                  <div className={`'col-span-1'`}></div>
                  <div id='infoBoxs' className={`${styles.infoBoxs} hover:bg-[#FACA43] xl:col-span-1 lg:col-span-1 md:col-span-1 sm:col-span-1 col-span-5 text-lg font-bold p-8`}>
          ...
          <div className='grid grid-cols-1 gap-1 xl:mt-40 lg:mt-40 md:mt-40 sm:mt-40 mt-16'>
            <div className='w-12/12  xl:pl-28 lg:pl-28 md:pl-28 sm:pl-28 pl-5'>
          ...
          <div className='grid grid-cols-1 gap-1 mt-28 p-5'>
          ...
          <div className='grid grid-cols-1 gap-1 mt-20 xl:pl-28 lg:pl-28 md:pl-28 sm:pl-28 pl-5'>                                    
            <div className='xl:w-8/12 lg:w-8/12 md:w-8/12 sm:w-8/12 w-12/12 '>
              ...
              <div id={styles.doreaDefinition} className='mt-5 xl:ml-14 lg:ml-14 md:m                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       l-14 sm:ml-14 ml-0 pr-3 pl-7 pt-7 pb-7 rounded-md'>
