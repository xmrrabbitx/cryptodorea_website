        ...
        <div className='container max-w-full'>
          ...
          <div className='grid grid-cols-2 gap-1'> 
            <div className='w-12/12 pl-28'>
              ...
              <div>
                  ...
                  <input type='text' placeholder='your email address...' className='text-md ml-3 pl-8 p-2 border border-2 border-solid border-gray-300 rounded-md'  />
              </div>
              <div>
                  <div></div>
              </div>
          ...
          <div className='grid grid-cols-1 gap-1 mt-28'>
            <div className='w-12/12 flex items-center justify-center'>
                  <input type='text' placeholder='your email address...' className='text-md w-96 pl-8 p-3 border-2 border-solid border-gray-300 rounded-md'  />
            </div>
            <div className='w-12/12 flex items-center justify-center'>
