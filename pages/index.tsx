...
import CashbackPic from "@/public/pics/cashbackEth.svg"
        ...
        <div className='container 2xl:mx-auto 2xl:max-w-screen-2xl  max-w-full  mt-5'>
          ...
          <div className='grid xl:grid-cols-5 lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-3 grid-cols-3 xl:gap-16 lg:gap-16 md:gap-16 sm:gap-16 gap-6 xl:mt-36 mt-16 p-5 word-break'>
            ...
            <div className='xl:col-span-1 col-span-1'>
              ...
              <div className={`${styles.percentsDescription} xl:text-center lg:text-center md:text-center sm:text-center text-center 2xl:text-xl xl:text-base lg:text-[15px] md:text-base sm:text-base text-[12px]`}>of US adults <br /> hold Crypto</div>
            </div>
            <div className='xl:col-span-1 col-span-1'>
              ...
              <div className={`${styles.percentsDescription} xl:text-center lg:text-center md:text-center sm:text-center text-center 2xl:text-xl xl:text-base lg:text-[15px] md:text-base sm:text-base  text-[12px]`}>Businesses accept Bitcoin in the U.S</div>
            </div>
            <div className='xl:col-span-1 col-span-1'>
            <div className={`${styles.percentsNumbers} xl:text-center lg:text-center md:text-center sm:text-center 2xl:text-7xl xl:text-6xl lg:text-6xl md:text-6xl sm:text-6xl text-4xl  xl:mt-0 text-center`}>45M</div>
              <div className={`${styles.percentsDescription} xl:text-center lg:text-center md:text-center sm:text-center text-center 2xl:text-xl xl:text-base lg:text-[15px] md:text-base sm:text-base  text-[12px]`}>of Americans <br /> use crypto</div>
            </div>
            <div className='xl:col-span-1 xl:inline lg:inline md:hidden sm:hidden hidden '></div>
          ...
          <div className='grid grid-cols-4 gap-1 mt-16'> 
            <div className='xl:col-span-1 xl:inline lg:inline md:hidden sm:hidden hidden '></div>
            <div className='xl:col-span-1 lg:col-span-1 md:col-span-2 sm:col-span-2 col-span-4 xl:text-right lg:text-right md:text-right sm:text-right text-center xl:text-9xl lg:text-8xl text-9xl xl:pr-10 lg:pr-10 md:pr-10 sm:pr-10 pr-0 content-center'> 
              <span className={styles.percentsNumbers}>98%</span>
            </div>
            <div className='xl:col-span-1 lg:col-span-1 md:col-span-2 sm:col-span-2 col-span-4 text-left xl:text-xl lg:text-[16px] text-xl pt-8 p-5 font-bold'>
          ...
          <div className='grid grid-cols-2 gap-1 xl:mt-28 mt-16'> 
            ...
            <div className='xl:col-span-1 lg:col-span-1 md:col-span-1 col-span-2 xl:p-0 lg:p-0  md:p-0 sm:p-0 p-5 grid items-center justify-center relative'>
                ...
                <Image 
                src={OrderPaidPic}
                className={`${customerStyle} bottom-5 absolute xl:right-28 right-10 opacity-0 xl:w-[220px] lg:w-[220px] md: sm: w-40 xl:animate-[order_2s_ease-out_forwards] animate-[orderSmall_2s_ease-out_forwards]`}
                width={220}
                ...
                <Image 
                src={CashbackPic}
                className={`${customerStyle} bottom-0 absolute xl:right-28 right-10 opacity-0 xl:w-[220px] lg:w-[220px] md: sm: w-40 xl:animate-[cashback_2s_ease-out_forwards_1s] animate-[cashbackSmall_2s_ease-out_forwards_1s]`}
                width={220}
              ...
              <p id={styles.doreaDefinitionTitle} className='2xl:text-4xl text-xl font-bold'>Why Crypto Dorea?</p>
                <div className='grid xl:grid-cols-5 lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-3 grid-cols-3 gap-5 mt-6 '>
                  ...
                  <div id='infoBoxs' className={`${styles.infoBoxs} hover:bg-[#FACA43] xl:col-span-1 lg:col-span-1 md:col-span-1 sm:col-span-1 col-span-5  xl:text-lg lg:text-lg md:text-lg sm:text-lg text-base font-bold p-8`}>
                    ...
                    <p className='pb-4 xl:text-[17px] lg:text-[16px] md:text-[16px] sm:text-[16px] text-[16px]'>Integrated into <br /> your E-Commerce</p>
                  ...
                  <p className='pb-4 xl:text-[17px] lg:text-[16px] md:text-[16px] sm:text-[16px] text-[16px]'>Simple Decentralised <br /> Payment Mechanism</p>
                  </div>
                  <div id='infoBoxs' className={`${styles.infoBoxs} hover:bg-[#FACA43] xl:col-span-1 lg:col-span-1 md:col-span-1 sm:col-span-1 col-span-5 xl:text-lg lg:text-lg md:text-lg sm:text-lg text-base font-bold p-8`}>
                  <div className=' flex items-center justify-center pb-3'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
                  ...
                  <p className='pb-4 xl:text-[17px] lg:text-[16px] md:text-[16px] sm:text-[16px] text-[16px]'>Low Cost <br/> Blockchain Fees</p>
          ...
          <div className='grid grid-cols-1 gap-1 xl:mt-40 lg:mt-40 md:mt-40 sm:mt-40 mt-16 xl:pr-0 md:pr-5 pr-0'>
            ...
            <div className='grid xl:grid-cols-5 lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-3 grid-cols-3 gap-5 mt-6'>
                  ...
                  <p className='pb-4 xl:text-[17px] lg:text-[16px] md:text-[16px] sm:text-[16px] text-[16px]'> Create a Crypto <br /> Cashback Program</p>
                  </div>
                  <div id='infoBoxs' className={`${styles.infoBoxs} hover:bg-[#FACA43] xl:col-span-1 lg:col-span-1 md:col-span-1 sm:col-span-1 col-span-5 xl:text-lg lg:text-lg md:text-lg sm:text-lg text-base font-bold p-8`}>
                  <div className='flex items-center justify-center pb-3'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
                  ...
                  <p className='pb-4 xl:text-[17px] lg:text-[16px] md:text-[16px] sm:text-[16px] text-[16px]'> Customize Your <br/> Cashback Program</p>
                  ...
                  <p className='pb-4 xl:text-[17px] lg:text-[16px] md:text-[16px] sm:text-[16px] text-[16px]'>Decenterlized Payment <br/> to Your Customers</p>
          ...
          <div className='grid grid-cols-1 gap-1 xl:mt-28 lg:mt-28 md:mt-28 sm:mt-28 mt-10 p-5'>
            <div className='w-12/12 flex items-center justify-center'>
                <p className='text-slate-700 xl:text-lg lg:text-lg md:text-lg sm:text-lg text-lg font-bold p-8 text-center'><span className='text-[#faa143]'>Crypto Dorea</span> Grows Your Business <span>to the Moon</span> 🚀</p>
            </div>
          </div>
          ...
          <div className='grid grid-cols-1 gap-1 mt-20 xl:pl-28 lg:pl-28 md:pl-8 sm:pl-8 xl:p-0 lg:p-5 md:p-5 p-5 '>                                    
            <div className='xl:w-10/12 lg:w-10/12 md:w-12/12 sm:w-12/12 w-12/12 '>
